...
import verifyTurnstileMiddleware from "../middlewares/verify-turnstile.middleware";
...
import { hashService, jwtService, turnstileService } from "./services.container";

export const authMiddleware = new AuthMiddleware(userRepository, membershipRepository, jwtService).validate
export const turnstileMiddleware = new verifyTurnstileMiddleware(turnstileService).verify
