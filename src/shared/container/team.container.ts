...
import { GetTeamDetailUseCase } from "../../modules/team/application/get-team-detail.use-case";
...
const getTeamDetail = new GetTeamDetailUseCase(teamRepository, membershipRepository)
