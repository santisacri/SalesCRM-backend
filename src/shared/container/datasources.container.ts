...
import { InvitationDatasource } from "../../modules/invitation/infraestructure/invitation.datasource";
...
export const invitationDatasource = new InvitationDatasource(prisma)