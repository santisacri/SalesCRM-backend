...
import { authController, authMiddleware, turnstileMiddleware } from "../../../shared/container/auth.container";
...
export class AuthRouter {
    static get routes(): Router {
        ...
        router.post('/register', [turnstileMiddleware, validateBody(registerUserSchema)], authController.register)
        router.post('/login', [turnstileMiddleware, validateBody(loginUserSchema)], authController.login)
